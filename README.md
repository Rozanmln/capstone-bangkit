...
# Restful APIs
We use **Javascript** language and **Node.js** framework to build the APIs. And also **Sequalize** library to implementing ORM (Object-Relational Mapping) in our database. Each URL will be explained below
