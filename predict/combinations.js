const combinations = {
  ...
  16: {
    ...
    Precaution:
      'avoid fatty spicy food, consume witch hazel, warm bath with epsom salt, consume alovera juice',
  },
  17: {
    '': '17',
    id: '17',
  ...
  22: {
    ...
    Precaution:
      'lie down flat and raise the leg high, use oinments, use vein compression, dont stand still for long',
  },
  23: {
    '': '23',
    id: '23',
  ...
  29: {
    ...
    Precaution:
      'meditation, reduce stress, use poloroid glasses in sun, consult doctor',
  },
  30: {
    '': '30',
    id: '30',
