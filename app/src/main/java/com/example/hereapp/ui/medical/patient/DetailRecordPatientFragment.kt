 ...
 * Use the [DetailRecordPatientFragment.newInstance] factory method to
...
class DetailRecordPatientFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DetailRecordPatientFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DetailRecordPatientFragment().apply {
