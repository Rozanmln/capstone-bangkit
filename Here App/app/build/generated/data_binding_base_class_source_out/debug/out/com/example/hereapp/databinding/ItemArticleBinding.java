...
public final class ItemArticleBinding implements ViewBinding {
  ...
  private ItemArticleBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivArticle,
  ...
  public static ItemArticleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemArticleBinding((LinearLayout) rootView, ivArticle, tvDescription);
    }
