 ...
 * Use the [AddRecordPatientFragment.newInstance] factory method to
...
class AddRecordPatientFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AddRecordPatientFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AddRecordPatientFragment().apply {
